  ...
  { -- Autoformat
    ...
    opts = {
      ...
      format_on_save = function(bufnr)
        -- Disabled format_on_save for filetype
        local disable = { html = true, htmldjango = true }
        ...
        local opts = {
          timeout_ms = 1000,
          lsp_fallback = not (disable[current_filetype] or disable_fallback[current_filetype]),
        }

        if disable[current_filetype] then
          opts.formatters = {}
        end
